---
title: The 60-Point Gap: Why We're Measuring the Wrong Customer
slug: the-60-point-gap-why-were-measuring-the-wrong-customer
published: 2026-03-04
excerpt: A Nature study shows LLMs achieve 94.9% accuracy on benchmarks but only 34.5% when laypeople use LLMs on physician-created scenarios. The gap reveals something deeper: We measure the model in isolation. We deploy to a human in distress. The system fails at the intersection.
url: https://data-decisions-and-clinics.com/the-60-point-gap-why-were-measuring-the-wrong-customer/
tags: Healthcare AI
...
The authors themselves note this limitation and call for "moving toward increasingly realistic conditions" once models pass scenario-based tests. They're right. But we need to go further.
...
Bridge operator thinking doesn't acknowledge this tension. It assumes if you build a great tool, both customers will be served. Bridge architect thinking names the tension explicitly and designs for both simultaneously, making the panicked person the primary customer.

When a physician sees the 34.5% failure rate, they think "people will avoid seeking care they need." When a product manager sees it, they think "this system wasn't architected for the actual interaction." Both readings are correct.

## The Training Data Gap

I published a piece called "Trained on the Wrong End of the Story." The argument: LLMs trained on documented clinical cases can't answer questions at the moment those cases were undocumented.
...
That's bridge operator thinking in its purest form: connect user to information and hope the user knows how to ask the right questions.
...
The authors themselves note their vignettes don't capture the emotional urgency of actual medical emergencies. They recommend moving toward more realistic conditions once models pass these early tests.

I agree. But I think the next layer is architectural: test with people in actual stress conditions, design for them systematically, and measure whether outcomes improve.

## The Implication

There's a line I keep coming back to: "The house of cards keeps going up because nobody gets promoted for saying we need to stop and design the architecture."

The same applies here. Nobody gets promoted for building a system where the panicked end user is the primary customer, not the benchmark. So we keep deploying general-purpose LLMs into healthcare contexts and waiting to see what fails.

The Nature study is rigorous and important. The authors themselves recognize what's missing: systematic testing with diverse, real users, and architectural scaffolding for safe deployment. That's not a criticism of the study. It's a recognition that interaction failure points toward a design problem.
...
**Reference:** Bean AM et al., "Reliability of LLMs as medical assistants for the general public: a randomized preregistered study," *Nature Medicine*, Volume 32, February 2026, pp. 609–615. DOI: [https://doi.org/10.1038/s41591-025-04074-y](https://doi.org/10.1038/s41591-025-04074-y)
