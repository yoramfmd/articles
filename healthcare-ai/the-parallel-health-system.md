---
title: "The Parallel Health System"
slug: the-parallel-health-system
published_at: 2026-04-02T23:29:13.000Z
custom_excerpt: "Patients aren't waiting for the healthcare system to catch up. They have wearables, direct-access labs, referral-free MRIs, and AI interpreting all of it. The parallel system is already running.\""
tags: [healthai]
feature_image: https://storage.ghost.io/c/e6/05/e605b234-3cc8-4fe4-97bb-2bb55b18b8fb/content/images/2026/04/Gemini_Generated_Image_i2izuei2izuei2iz.png
source: ghost
---
...
I tested Amazon's Health AI recently. Not by design: it appeared on my Amazon homepage while I was dealing with a splitting headache. The experience was simple and easy to navigate. One honest design note: long text responses are not ideal when the right side of your skull is pulsating.

What struck me was not the AI itself. It was the architecture around it.
...
CVS has assembled a comparable stack through different acquisitions: MinuteClinic, Aetna, and Oak Street Health for the primary care layer. Walmart built similar infrastructure before retreating from its clinic network in 2024. What Amazon brings that neither has fully replicated is a consumer surface hundreds of millions of people interact with daily, layered over clinical infrastructure and pharmacy logistics.

The middle tier is also where AI is being most aggressively integrated into accessible clinical workflows right now. Whether consumer trust transfers meaningfully to these AI-enhanced encounters is the question that will define how this layer develops.
...
The privacy landscape is equally uneven. HIPAA covers healthcare providers and their business associates, but as a matter of current law it does not extend to most consumer health apps, wearables, or DTC lab platforms. A patient integrating CGM data, genetic reports, and imaging findings through an AI health tool is operating almost entirely outside HIPAA's protections. The FTC's Health Breach Notification Rule provides some coverage for certain data breaches, but the gaps are substantial and largely invisible to the patient using these services.

Cost remains the most direct barrier. Cash-pay whole-body MRI services currently range from a few hundred to several thousand dollars depending on provider and scope. Alzheimer's biomarker panels cost several hundred dollars out of pocket. Comprehensive DTC blood panels are rarely covered by insurance. The patients who most need alternative access pathways, the uninsured, the lower-income, those without a regular care relationship, are largely priced out of the premium end of this ecosystem. The most capable tools remain easiest for people with disposable income and time. Access is expanding, but it is expanding unevenly.

---

## The Data Problem Nobody Is Solving

As a product manager who has spent years thinking about how data moves through enterprise systems, I cannot look at this ecosystem without seeing a familiar problem.

Every tool in the patient's toolkit generates data in its own format, stored in its own system, governed by its own terms. The CGM data lives on Dexcom's platform. The ECG traces are in Apple Health. The genetic report is on a genetics service's servers. The lab results are in Quest's portal. The imaging report is a PDF from the radiology provider. There is no semantic layer connecting them. The AI interpreting any one data stream has no awareness of the others. The patient has done the hard work of acquiring the data. She has not had the benefit of a system designed to make sense of it as a whole.

The documentation gap makes the governance problem concrete. When a patient arrives with an AI-generated differential, three months of CGM data, and a radiologist-reviewed MRI report, what does the clinical encounter record? The note says "patient seen." There is no ICD code for what actually happened. No billing modifier for "AI-informed encounter." No structured field for "physician reviewed and partially accepted AI output."

At the rate this ecosystem is growing, the ICD-10 classification system is going to need a new chapter. Something along the lines of:
