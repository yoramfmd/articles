...
excerpt: In healthcare, AI can already predict. The hard problem is reasoning, and reasoning depends entirely on context. The physician who takes a complete history, examines carefully, and aggregates everything from the EHR to the nursing home fax is not being thorough. They are building the product.
url: https://data-decisions-and-clinics.com/the-context-is-the-product/
tags: Product Management, Healthcare AI
...
[In my previous piece](https://data-decisions-and-clinics.com/what-do-we-do-with-the-frameworks/), I argued that AI made prediction cheap and the value shifted to whoever owns the best data. A physician friend who read it sent me a message: "You are describing us. We have been sitting on the most valuable data in the world for thirty years and treating it as a billing problem."
...
This is the gap between what healthcare AI can do today and what the clinical encounter requires. Prediction tells you something is happening. Reasoning tells you what it means for this patient, in this moment, given everything you know about them.

> ***The sepsis score tells you something is happening. Reasoning tells you what it means for this patient, in this moment, given everything you know about them. Those are not the same problem.***
...
*This piece is the second in a series. The first, "*[What Do We Do With the Frameworks?](https://data-decisions-and-clinics.com/what-do-we-do-with-the-frameworks/)*" makes the economic case for why the data layer matters more than the model layer in an AI-first world.*
